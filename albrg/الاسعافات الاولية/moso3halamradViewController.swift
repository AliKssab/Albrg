//
//  moso3halamradViewController.swift
//  albrg
//
...
class moso3halamradViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    private func loadData() {
        ...
        do {
            ...
            self.data = try decoder.decode([tataModel].self, from: jsonData)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as? moso3hTableViewCell else {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let calender = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "webViewControlleR") as! webViewControlleR
